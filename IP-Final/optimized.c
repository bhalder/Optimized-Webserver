 ...
 * @Author - Barun Halder
 * @AndrewID - bhalder
 * Concurrent server implemented using Pthread. 
 * Adopted from tinyserver.
 * This is the baseline server for Individual Project
*/
...
/******* GLOBALS ********/
// All the threads will access these variables for performing the 
// CGI related tasks 

// This will be the function stub used for addition
int (*functionstub)(char*);
void *dlhandle;
